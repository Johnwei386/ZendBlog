...
return array(
    ...
    "File was not uploaded" => "请选择上传文件",
    "File exceeds the defined ini size" => "文件大小超过了php.ini的限制",
    ...
    "The mimetype of file '%value%' could not be detected" => "文件'%value%'的媒体类型无法检测",
    "File '%value%' is not readable or does not exist" => "文件'%value%'无法读取或不存在",
    "File has an incorrect mimetype of '%type%'" => "上传文件的mime类型不能为'%type%'，只支持png、jpeg、jpg、gif格式的图片文件",
    "File has an incorrect extension" => "上传文件的扩展名不正确，非图片格式",
    ...
    "Maximum allowed size for file is '%max%' but '%size%' detected" => "上传文件的大小%size%超出范围，最大允许'%max%'",
